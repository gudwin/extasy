<?
namespace Extasy\Users\profile;

use \EventController;
use \Exception;
use \Extasy\Columns\Password as passwordColumn;
use \Extasy\Users\login\controller\AuthorizationRequired;
use \Extasy\Users\login\controller\Login;
use \Faid\DB;
use \SystemRegister;
use \UsersLogin;

require_once SETTINGS_PATH . 'users/profile/form.cfg.php';
class ProfileController extends AuthorizationRequired {
	const PageConfigName = 'users.profile.pageConfig';
	/**
	...
	public function change() {
		...
		if ( !empty($_POST[ 'password' ]) ) {
			...
			try {
				...
				UsersLogin::login($this->aProfile->login->getValue(), $password);
	...
	public function showChangeForm() {
		$this->aParse [ 'aMeta' ] = array(
			...
			'title'       => $this->aProfile->login->getValue(),
